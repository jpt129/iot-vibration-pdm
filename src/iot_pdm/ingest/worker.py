...
async def handle_features(topic: str, payload: bytes) -> None:
    ...
    row = {
        ...
        "accel_x_rms": msg.metrics.accel_x_rms,
        "accel_y_rms": msg.metrics.accel_y_rms,
        "accel_mag_rms": msg.metrics.accel_mag_rms,
        "therm_gradient_c": msg.metrics.therm_gradient_c,
        "therm_hotspot_pct": msg.metrics.therm_hotspot_pct,
